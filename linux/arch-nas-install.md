...
### 基础包安装
```bash
pacstrap -K /mnt base linux linux-headers linux-firmware amd-ucode nano xfsprogs sudo-rs base-devel git networkmanager lvm2
```
...
```bash
paru -S visual-studio-code-cli-bin
```
