...
### 安装Miniconda3
1. 点击[此链接](https://mirrors.tuna.tsinghua.edu.cn/anaconda/miniconda/Miniconda3-latest-Windows-x86_64.exe)下载最新Miniconda3。
2. 选择为所有用户安装。
...
4. Ctrl + Shift + P打开命令面板，选择`Python：选择解释器`，选择`C:\Dev\Runtimes\miniconda3\python.exe`
...
2. 安装`python`和`Code Runner`扩展。
3. 将`code-runner`扩展的`runInTerminal`设置开启。
4. 打开命令面板，选择`Python：选择解释器`，选择`miniconda3`
5. 点击Python文件右上角的`Run Code`按钮即可运行。